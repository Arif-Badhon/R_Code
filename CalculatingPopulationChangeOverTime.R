...
pop_year_one <- 691000 #population of year 1927
pop_year_two <- 15029231 #population of the year 2017
pop_change <- (pop_year_two - pop_year_one)

percentage_gr <- (pop_change/pop_year_one)*100

annual_gr <- percentage_gr / 4

print(annual_gr)

calculate_annual_growth(1927,1950,2000,2017, "Dhaka")
